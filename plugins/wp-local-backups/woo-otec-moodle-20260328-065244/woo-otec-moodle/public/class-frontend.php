...
final class Woo_OTEC_Moodle_Frontend {
    ...
    public function enqueue_assets(): void {
        ...
        .tax-product_cat .products .product .button {
            background: {$shop_btn};
            border-color: {$shop_btn};
            color: #fff;
        }
        .single-product .pcc-course-single-box .single_add_to_cart_button {
            background: {$single_btn};
            border-color: {$single_btn};
            color: #fff;
        }
        .woocommerce-cart .wc-proceed-to-checkout a.checkout-button {
            background: {$cart_btn};
            border-color: {$cart_btn};
            color: #fff;
        }
        .woocommerce-checkout #place_order {
            background: {$checkout_btn};
            border-color: {$checkout_btn};
            color: #fff;
        }";
