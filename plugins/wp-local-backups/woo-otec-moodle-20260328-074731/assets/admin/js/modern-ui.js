    ...
    const PCC_Admin = {
        ...
        initAppearanceTools: function() {
            ...
            function updateSingleProductPreview() {
                ...
                const shortText = $selectedOption.data('short') || 'Asi se vera el bloque principal del curso con tu paleta actual.';
                ...
                const descriptionHeading = $('#woo_otec_moodle_single_description_heading').val() || 'Descripcion del curso';
            ...
            function updateCartPreview() {
                updateMiniBanner($cartPreview, {
                    title: $('#woo_otec_moodle_cart_intro_title').val() || 'Tu carrito de capacitacion',
            ...
            function updateCheckoutPreview() {
                updateMiniBanner($checkoutPreview, {
                    title: $('#woo_otec_moodle_checkout_intro_title').val() || 'Ultimo paso para activar tus cursos',
            ...
            function updateEmailPreview() {
                ...
                const title = $('#woo_otec_moodle_email_builder_heading_appearance').val() || 'Tus accesos ya estan listos';
                const text = $('#woo_otec_moodle_email_builder_intro_appearance').val() || 'Tu compra fue confirmada correctamente. Aqui tienes los datos para ingresar a tu plataforma.';
            ...
            function updatePortalPreview() {
                updateMiniBanner($portalPreview, {
                    ...
                    text: $('#woo_otec_moodle_portal_intro_text').val() || 'Desde aqui puedes entrar directamente a cada curso comprado.',
        ...
        initTemplateTools: function() {
            ...
            function persistTemplateConfig(productId, selectedFields, silent) {
                ...
                $.post(wooOtecMoodleAdmin.ajaxUrl, {
                    ...
                    renderEmptyPreview('Error de conexion al actualizar la vista previa.');
                });
            }
