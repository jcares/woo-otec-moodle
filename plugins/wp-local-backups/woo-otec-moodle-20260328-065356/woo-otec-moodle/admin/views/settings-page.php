                ...
                <div class="pcc-card">
                    ...
                    <section class="pcc-tab-panel <?php echo $active_tab === 'appearance' ? 'is-active' : ''; ?>" id="pcc-panel-appearance" data-panel="appearance" role="tabpanel">
                        ...
                        <div class="pcc-appearance-nav">
                            ...
                            <button type="button" class="pcc-appearance-tab <?php echo $appearance_profile === 'portal' ? 'is-active' : ''; ?>" data-appearance-tab="portal">Portal</button>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="product">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                ...
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_single_button_color">Color boton compra</label></th>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="shop">
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-shop-preview style="background: <?php echo esc_attr((string) $core->get_option('shop_color_bg', '#f8fbff')); ?>;">
                                    ...
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('shop_color_text', '#2b4b63')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('shop_intro_text', 'Descubre nuestros cursos disponibles y selecciona el que mejor se ajusta a tu objetivo.')); ?></p>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="cart">
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-cart-preview style="background: <?php echo esc_attr((string) $core->get_option('cart_color_bg', '#f5fbf8')); ?>;">
                                    ...
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('cart_color_text', '#355846')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('cart_intro_text', 'Revisa tus cursos antes de finalizar el pago.')); ?></p>
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('cart_color_button', '#1f9d6f')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('cart_color_button', '#1f9d6f')); ?>;">
                                        <span data-preview-button>Continuar al pago</span>
                                    </button>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="checkout">
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-checkout-preview style="background: <?php echo esc_attr((string) $core->get_option('checkout_color_bg', '#fff8f1')); ?>;">
                                    <h5 style="color: <?php echo esc_attr((string) $core->get_option('checkout_color_title', '#7b4b12')); ?>;" data-preview-title><?php echo esc_html((string) $core->get_option('checkout_intro_title', 'Ultimo paso para activar tus cursos')); ?></h5>
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('checkout_color_text', '#6f5a40')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('checkout_intro_text', 'Completa tus datos para activar el acceso inmediato a tus cursos.')); ?></p>
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('checkout_color_button', '#d9822b')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('checkout_color_button', '#d9822b')); ?>;">
                                        <span data-preview-button><?php echo esc_html((string) $core->get_option('checkout_button_text', 'Finalizar compra')); ?></span>
                                    </button>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="portal">
                            <div class="pcc-appearance-head">
                                <h4>Portal / Mis cursos</h4>
                                <p>Configura el bloque del shortcode y el boton de acceso a cursos de forma independiente.</p>
                            </div>
                            <div class="pcc-appearance-layout">
                            <div class="pcc-appearance-controls">
                            <table class="form-table pcc-form-table-compact">
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_title">Titulo portal</label></th>
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_portal_title" name="woo_otec_moodle_portal_title" value="<?php echo esc_attr((string) $core->get_option('portal_title', 'Mis cursos')); ?>"></td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_intro_text">Texto apoyo</label></th>
                                ...
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_button_text">Texto boton</label></th>
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_portal_button_text" name="woo_otec_moodle_portal_button_text" value="<?php echo esc_attr((string) $core->get_option('portal_button_text', 'Entrar al curso')); ?>"></td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_color_bg">Color fondo</label></th>
                                ...
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_color_title">Color titulo</label></th>
                                ...
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_color_text">Color texto</label></th>
                                ...
                                <tr>
                                    <th scope="row"><label for="woo_otec_moodle_portal_color_button">Color boton</label></th>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-portal-preview style="background: <?php echo esc_attr((string) $core->get_option('portal_color_bg', '#f7fbff')); ?>;">
                                    <h5 style="color: <?php echo esc_attr((string) $core->get_option('portal_color_title', '#173246')); ?>;" data-preview-title><?php echo esc_html((string) $core->get_option('portal_title', 'Mis cursos')); ?></h5>
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('portal_color_text', '#567187')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('portal_intro_text', 'Desde aqui puedes entrar directamente a cada curso comprado.')); ?></p>
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('portal_color_button', '#0f3d5e')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('portal_color_button', '#0f3d5e')); ?>;">
                                        <span data-preview-button><?php echo esc_html((string) $core->get_option('portal_button_text', 'Entrar al curso')); ?></span>
                                    </button>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-email" data-appearance-email-preview style="background: <?php echo esc_attr((string) $core->get_option('email_color_bg', '#f3f8fc')); ?>;">
                                    <div class="pcc-appearance-mini-email__head" style="background: <?php echo esc_attr((string) $core->get_option('email_color_primary', '#0f3d5e')); ?>;">
                                        <strong data-preview-title><?php echo esc_html((string) $core->get_option('email_builder_heading', 'Tus accesos ya estan listos')); ?></strong>
                                    </div>
                                    <div class="pcc-appearance-mini-email__body">
                                        <p data-preview-text><?php echo esc_html((string) $core->get_option('email_builder_intro', 'Tu compra fue confirmada correctamente. Aqui tienes los datos para ingresar a tu plataforma.')); ?></p>
                                        <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('email_color_accent', '#1f9d6f')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('email_color_accent', '#1f9d6f')); ?>;">
                                            <span data-preview-button><?php echo esc_html((string) $core->get_option('email_builder_button_text', 'Acceder a mis cursos')); ?></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
