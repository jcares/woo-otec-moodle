            ...
            <main class="pcc-dashboard-main">
                <div class="pcc-card">
                    ...
                    <section class="pcc-tab-panel <?php echo $active_tab === 'templates' ? 'is-active' : ''; ?>" id="pcc-panel-templates" data-panel="templates" role="tabpanel">
                        ...
                        <p class="description">Activa los campos que quieras mostrar y revisa abajo como quedaran visualmente en la plantilla.</p>
                        ...
                        <p class="description pcc-template-preview-description">Esta vista se actualiza segun el curso de referencia y los campos que dejes activos.</p>
                        <div class="pcc-template-preview-card" style="margin-top: 16px;">
                            <h4>Vista previa en vivo</h4>
                            <div data-template-live-preview>
                                <p class="description">Selecciona un curso y marca los campos para ver la plantilla en tiempo real.</p>
                            </div>
                        </div>
                    </section>
