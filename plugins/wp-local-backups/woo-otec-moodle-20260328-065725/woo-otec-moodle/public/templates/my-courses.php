...
$portal_title = (string) Woo_OTEC_Moodle_Core::instance()->get_option('portal_title', 'Mis cursos');
$portal_intro = (string) Woo_OTEC_Moodle_Core::instance()->get_option('portal_intro_text', 'Desde aqui puedes entrar directamente a cada curso comprado.');
$portal_button = (string) Woo_OTEC_Moodle_Core::instance()->get_option('portal_button_text', 'Entrar al curso');
?>
