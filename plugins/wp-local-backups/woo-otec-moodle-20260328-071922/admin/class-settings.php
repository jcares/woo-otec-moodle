...
/**
 * Gestiona el registro del menu, las opciones del plugin y los helpers de vista del panel.
...
final class Woo_OTEC_Moodle_Settings {
    ...
    private function get_meta_labels(): array {
        return array(
            ...
            '_moodle_id'                   => 'Codigo interno del curso',
            '_moodle_category_id'          => 'Categoria del curso',
            '_course_category_name'        => 'Nombre de la categoria',
            'course_category_name'         => 'Nombre de la categoria',
            '_course_shortname'            => 'Nombre corto del curso',
            'course_shortname'             => 'Nombre corto del curso',
            '_course_code'                 => 'Codigo interno de Moodle',
            'course_code'                  => 'Codigo interno de Moodle',
            '_course_language'             => 'Idioma del curso',
            'course_language'              => 'Idioma del curso',
            '_course_visibility'           => 'Estado de publicacion en Moodle',
            'course_visibility'            => 'Estado de publicacion en Moodle',
            '_moodle_course_details'       => 'Descripcion completa del curso',
            '_moodle_course_details_plain' => 'Resumen del curso',
            '_price'                       => 'Precio actual',
            '_regular_price'               => 'Precio normal (sin descuento)',
            '_sku'                         => 'Codigo del producto',
            ...
            'moodle_course_id'             => 'Codigo alternativo del curso',
            '_pcc_synced'                  => 'Sincronizado con la plataforma',
            '_product_attributes'          => 'Caracteristicas del curso',
            '_tax_status'                  => 'Aplicacion de impuestos',
            '_tax_class'                   => 'Tipo de impuesto',
            '_duration'                    => 'Duracion del curso',
            'duration'                     => 'Duracion del curso',
            '_modality'                    => 'Modalidad',
            'modality'                     => 'Modalidad',
            '_course_format'               => 'Formato del curso',
            'course_format'                => 'Formato del curso',
            '_sence_code'                  => 'Codigo SENCE',
            'sence_code'                   => 'Codigo SENCE',
            '_total_hours'                 => 'Horas totales',
            'total_hours'                  => 'Horas totales',
            '_sections_count'              => 'Secciones',
            'sections_count'               => 'Secciones',
            '_certificate_available'       => 'Certificado de finalizacion',
            'certificate_available'        => 'Certificado de finalizacion',
        );
    }
