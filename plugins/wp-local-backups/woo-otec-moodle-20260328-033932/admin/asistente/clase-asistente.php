...
final class Woo_OTEC_Moodle_Asistente {
    ...
    public function render_wizard(): void {
        if (!current_user_can('manage_options')) {
            wp_die('No tienes permisos suficientes para acceder a esta pagina.');
        }
        ...
        if (file_exists($view_path)) {
            ...
            echo '<div class="notice notice-error"><p>No se encontrA la plantilla principal del asistente.</p></div>';
        }
    }
