...
$portal_title = (string) Woo_OTEC_Moodle_Core::instance()->get_option('portal_title', 'My courses');
$portal_intro = (string) Woo_OTEC_Moodle_Core::instance()->get_option('portal_intro_text', 'From here you can enter each purchased course directly.');
$portal_button = (string) Woo_OTEC_Moodle_Core::instance()->get_option('portal_button_text', 'Enter course');
?>
