            ...
            <main class="pcc-dashboard-main">
                <div class="pcc-card">
                    ...
                    <section class="pcc-tab-panel <?php echo $active_tab === 'general' ? 'is-active' : ''; ?>" id="pcc-panel-general" data-panel="general" role="tabpanel">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="regular-text" type="text" id="woo_otec_moodle_default_instructor" name="woo_otec_moodle_default_instructor" value="<?php echo esc_attr((string) $core->get_option('default_instructor', 'Not assigned')); ?>">
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="product">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_single_button_text" name="woo_otec_moodle_single_button_text" value="<?php echo esc_attr((string) $core->get_option('single_button_text', 'Buy course')); ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_single_description_heading" name="woo_otec_moodle_single_description_heading" value="<?php echo esc_attr((string) $core->get_option('single_description_heading', 'Course description')); ?>"></td>
                                </tr>
                                <tr>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-card pcc-appearance-mini-card--<?php echo esc_attr((string) $core->get_option('template_style', 'classic')); ?>" data-appearance-single-preview>
                                    ...
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('single_button_color', '#1f9d6f')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('single_button_color', '#1f9d6f')); ?>;">
                                        <?php echo esc_html((string) $core->get_option('single_button_text', 'Buy course')); ?>
                                    </button>
                                    <div class="pcc-appearance-mini-description">
                                        <span data-preview-description-heading><?php echo esc_html((string) $core->get_option('single_description_heading', 'Course description')); ?></span>
                                    </div>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="shop">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_shop_intro_title" name="woo_otec_moodle_shop_intro_title" value="<?php echo esc_attr((string) $core->get_option('shop_intro_title', 'Explore our course catalog')); ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_shop_button_text" name="woo_otec_moodle_shop_button_text" value="<?php echo esc_attr((string) $core->get_option('shop_button_text', 'View course')); ?>"></td>
                                </tr>
                                <tr>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-shop-preview style="background: <?php echo esc_attr((string) $core->get_option('shop_color_bg', '#f8fbff')); ?>;">
                                    <h5 style="color: <?php echo esc_attr((string) $core->get_option('shop_color_title', '#21405a')); ?>;" data-preview-title><?php echo esc_html((string) $core->get_option('shop_intro_title', 'Explora nuestra oferta de cursos')); ?></h5>
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('shop_color_text', '#2b4b63')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('shop_intro_text', 'Discover our available courses and choose the one that best fits your goal.')); ?></p>
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('shop_color_button', '#0f3d5e')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('shop_color_button', '#0f3d5e')); ?>;">
                                        <span data-preview-button><?php echo esc_html((string) $core->get_option('shop_button_text', 'Ver curso')); ?></span>
                                    </button>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="cart">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_cart_intro_title" name="woo_otec_moodle_cart_intro_title" value="<?php echo esc_attr((string) $core->get_option('cart_intro_title', 'Your training cart')); ?>"></td>
                                </tr>
                                <tr>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-cart-preview style="background: <?php echo esc_attr((string) $core->get_option('cart_color_bg', '#f5fbf8')); ?>;">
                                    <h5 style="color: <?php echo esc_attr((string) $core->get_option('cart_color_title', '#1d5a41')); ?>;" data-preview-title><?php echo esc_html((string) $core->get_option('cart_intro_title', 'Tu carrito de capacitacion')); ?></h5>
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('cart_color_text', '#355846')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('cart_intro_text', 'Review your courses before completing the payment.')); ?></p>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="checkout">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_checkout_intro_title" name="woo_otec_moodle_checkout_intro_title" value="<?php echo esc_attr((string) $core->get_option('checkout_intro_title', 'Last step to activate your courses')); ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_checkout_button_text" name="woo_otec_moodle_checkout_button_text" value="<?php echo esc_attr((string) $core->get_option('checkout_button_text', 'Complete purchase')); ?>"></td>
                                </tr>
                                <tr>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-checkout-preview style="background: <?php echo esc_attr((string) $core->get_option('checkout_color_bg', '#fff8f1')); ?>;">
                                    <h5 style="color: <?php echo esc_attr((string) $core->get_option('checkout_color_title', '#7b4b12')); ?>;" data-preview-title><?php echo esc_html((string) $core->get_option('checkout_intro_title', 'Last step to activate your courses')); ?></h5>
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('checkout_color_text', '#6f5a40')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('checkout_intro_text', 'Complete your information to activate immediate access to your courses.')); ?></p>
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('checkout_color_button', '#d9822b')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('checkout_color_button', '#d9822b')); ?>;">
                                        <span data-preview-button><?php echo esc_html((string) $core->get_option('checkout_button_text', 'Complete purchase')); ?></span>
                                    </button>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="portal">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_portal_title" name="woo_otec_moodle_portal_title" value="<?php echo esc_attr((string) $core->get_option('portal_title', 'My courses')); ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_portal_button_text" name="woo_otec_moodle_portal_button_text" value="<?php echo esc_attr((string) $core->get_option('portal_button_text', 'Enter course')); ?>"></td>
                                </tr>
                                <tr>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-banner" data-appearance-portal-preview style="background: <?php echo esc_attr((string) $core->get_option('portal_color_bg', '#f7fbff')); ?>;">
                                    <h5 style="color: <?php echo esc_attr((string) $core->get_option('portal_color_title', '#173246')); ?>;" data-preview-title><?php echo esc_html((string) $core->get_option('portal_title', 'My courses')); ?></h5>
                                    <p style="color: <?php echo esc_attr((string) $core->get_option('portal_color_text', '#567187')); ?>;" data-preview-text><?php echo esc_html((string) $core->get_option('portal_intro_text', 'From here you can enter each purchased course directly.')); ?></p>
                                    <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('portal_color_button', '#0f3d5e')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('portal_color_button', '#0f3d5e')); ?>;">
                                        <span data-preview-button><?php echo esc_html((string) $core->get_option('portal_button_text', 'Enter course')); ?></span>
                                    </button>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="pcc-appearance-group" data-appearance-group="email">
                            ...
                            <table class="form-table pcc-form-table-compact">
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_email_builder_heading_appearance" name="woo_otec_moodle_email_builder_heading" value="<?php echo esc_attr((string) $core->get_option('email_builder_heading', 'Your access details are ready')); ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="regular-text" type="text" id="woo_otec_moodle_email_builder_button_text_appearance" name="woo_otec_moodle_email_builder_button_text" value="<?php echo esc_attr((string) $core->get_option('email_builder_button_text', 'Access my courses')); ?>"></td>
                                </tr>
                                <tr>
                            ...
                            <div class="pcc-appearance-preview">
                                <div class="pcc-appearance-mini-email" data-appearance-email-preview style="background: <?php echo esc_attr((string) $core->get_option('email_color_bg', '#f3f8fc')); ?>;">
                                    <div class="pcc-appearance-mini-email__head" style="background: <?php echo esc_attr((string) $core->get_option('email_color_primary', '#0f3d5e')); ?>;">
                                        <strong data-preview-title><?php echo esc_html((string) $core->get_option('email_builder_heading', 'Your access details are ready')); ?></strong>
                                    </div>
                                    <div class="pcc-appearance-mini-email__body">
                                        <p data-preview-text><?php echo esc_html((string) $core->get_option('email_builder_intro', 'Your purchase has been confirmed successfully. Here are your access details for the platform.')); ?></p>
                                        <button type="button" class="button button-primary" style="background: <?php echo esc_attr((string) $core->get_option('email_color_accent', '#1f9d6f')); ?>; border-color: <?php echo esc_attr((string) $core->get_option('email_color_accent', '#1f9d6f')); ?>;">
                                            <span data-preview-button><?php echo esc_html((string) $core->get_option('email_builder_button_text', 'Access my courses')); ?></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section class="pcc-tab-panel <?php echo $active_tab === 'logs' ? 'is-active' : ''; ?>" id="pcc-panel-logs" data-panel="logs" role="tabpanel">
                        <h3><?php echo esc_html__('Error log', 'woo-otec-moodle'); ?></h3>
                        <div class="pcc-log-viewer-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                            <strong><?php echo esc_html__('Latest 100 log lines:', 'woo-otec-moodle'); ?></strong>
                            <a href="<?php echo esc_url(admin_url('admin-ajax.php?action=woo_otec_moodle_export_logs&nonce=' . wp_create_nonce('woo_otec_moodle_export_logs'))); ?>" class="button button-secondary"><?php echo esc_html__('Export log', 'woo-otec-moodle'); ?></a>
                        </div>
                        <div class="pcc-log-viewer" style="background: #1e1e1e; color: #d4d4d4; padding: 15px; border-radius: 4px; font-family: monospace; font-size: 12px; max-height: 400px; overflow-y: auto;">
                            ...
                            if (!empty($error_log)) {
                                ...
                                echo esc_html__('There are no recent entries.', 'woo-otec-moodle');
                            }
                            ?>
                        </div>
                    </section>
