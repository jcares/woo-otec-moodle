                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="width:640px;max-width:640px;background-color:#ffffff;border-radius:16px;overflow:hidden;">
                    <tr>
                        <td style="background-color:#0f172a;padding:32px 40px;text-align:center;">
                            <p style="margin:0 0 8px;font-size:12px;letter-spacing:1px;text-transform:uppercase;color:#93c5fd;">Welcome to {{sitio}}</p>
                            <h1 style="margin:0;font-size:28px;line-height:1.2;color:#ffffff;">Your access details are ready</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px 40px 12px;">
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">Hello {{nombre}},</p>
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">Your purchase has been confirmed successfully. Here are your access details for the platform.</p>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;border:1px solid #e5e7eb;border-radius:12px;background-color:#f8fafc;">
                                <tr>
                                    <td style="padding:18px 20px;border-bottom:1px solid #e5e7eb;">
                                        <p style="margin:0 0 4px;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#64748b;">User</p>
                                        <p style="margin:0;font-size:15px;line-height:1.5;color:#111827;">{{email}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:18px 20px;border-bottom:1px solid #e5e7eb;">
                                        <p style="margin:0 0 4px;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#64748b;">Password</p>
                                        <p style="margin:0;font-size:15px;line-height:1.5;color:#111827;">{{password}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0 0 4px;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#64748b;">Courses</p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
                                <tr>
                                    <td align="center" bgcolor="#0d6efd" style="border-radius:999px;">
                                        <a href="{{url_acceso}}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:bold;line-height:1.2;color:#ffffff;text-decoration:none;">Access my courses</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:12px 40px 36px;">
                            <p style="margin:0;font-size:14px;line-height:1.7;color:#475569;">If the button does not work, copy this link into your browser:<br><a href="{{url_acceso}}" style="color:#0d6efd;text-decoration:none;word-break:break-all;">{{url_acceso}}</a></p>
                        </td>
                    </tr>
                </table>
            </td>
...
return array(
    ...
    'email_enabled'           => 'yes',
    'email_from_address'      => '',
    'email_from_name'         => 'Cipres Alto Virtual',
    ...
    'portal_color_bg'         => '#f7fbff',
    'portal_color_title'      => '#173246',
    'portal_color_text'       => '#567187',
    'portal_color_button'     => '#0f3d5e',
