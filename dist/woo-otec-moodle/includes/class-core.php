...
final class Woo_OTEC_Moodle_Core {
    ...
    public function normalize_localized_defaults(): void {
        ...
        $legacy_values = array(
            ...
            'cart_intro_title' => array('Tu carrito de capacitación'),
            'portal_title' => array('Mis cursos'),
            'portal_intro_text' => array('Desde aquí puedes entrar directamente a cada curso comprado.'),
            'portal_button_text' => array('Entrar al curso'),
            'email_builder_heading' => array('Tus accesos ya están listos'),
            'email_builder_intro' => array('Tu compra fue confirmada correctamente. Aquí tienes los datos para ingresar a tu plataforma.'),
