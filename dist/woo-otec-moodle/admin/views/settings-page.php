...
$email_from_name = (string) $core->get_option('email_from_name', '');
                    ...
                    <section class="pcc-tab-panel <?php echo $active_tab === 'emails' ? 'is-active' : ''; ?>" id="pcc-panel-emails" data-panel="emails" role="tabpanel">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="regular-text" type="text" id="woo_otec_moodle_email_from_name" name="woo_otec_moodle_email_from_name" value="<?php echo esc_attr((string) $core->get_option('email_from_name', '')); ?>">
                                    <p class="pcc-field-help"><?php echo esc_html__('Example: Cipres Alto Virtual', 'woo-otec-moodle'); ?></p>
                                </td>
                            </tr>
                            <tr>
