...
final class Woo_OTEC_Moodle_Admin {
    ...
    public function boot(): void {
        ...
        // Silenciador de aviso SSL para entornos locales (v2.1.33)
        add_filter('woocommerce_allow_check_for_ssl', '__return_false');
    }
    ...
    public function render_logs_page(): void {
        ...
        $this->render_view('logs-page.php', $data);
    }
    ...
    private function get_default_tab(): string {
        $allowed_tabs = array('inicio', 'general', 'sync', 'sso', 'templates', 'appearance', 'emails', 'logs');
        $tab          = sanitize_key((string) ($_GET['tab'] ?? 'inicio'));
        return in_array($tab, $allowed_tabs, true) ? $tab : 'inicio';
    }
}
