...
<table class="form-table">
    <tr>
        ...
        <td>
            ...
            <p class="description">El enlace exacto con el que tus alumnos entran a tomar sus cursos. Cópialo de tu navegador asegurando que empiece con <strong>https://</strong></p>
        </td>
    </tr>
    <tr>
        <th><label for="moodle_token">Llave Maestra (Token de conexión)</label></th>
        <td>
            <input type="password" name="moodle_token" id="moodle_token" value="<?php echo esc_attr($moodle_token); ?>" class="regular-text" required>
            <p class="description">Es un código secreto largo que se genera dentro de tu plataforma Moodle, en la sección de "Servicios Externos". Permite que esta tienda pueda crear alumnos y matricularlos por ti automáticamente tras cada compra.</p>
        </td>
    </tr>
</table>
